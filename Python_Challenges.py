...
chain_text = input("enter some large string text: ")

def reed_johnny_alliance (reedvsjohnny):
    if reedvsjohnny.count('r') != reedvsjohnny.count('j'):
        print(False)
        
    elif reedvsjohnny.count('r') == reedvsjohnny.count('j') and reedvsjohnny.count('r') != 0 :
        print(True)
        
    elif reedvsjohnny.count('r') == 0 and reedvsjohnny.count('j') == 0:
        print(True)
        
        

    
reed_johnny_alliance(chain_text)
